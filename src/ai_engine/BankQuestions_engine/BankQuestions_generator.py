...
# from src.ai_engine.llm_generators.BankQuestions_prompts import get_bank_questions_generation_prompt
...
#         if not distilled_content or not distilled_content.get("content"):
#             raise EmptyContentError(
#                 EMPTY_SOURCE_CONTENT.format(source_url=source_url)
#             )
...
#         primary_item = next(
#             (i for i in distilled_results if str(i.get("url")) == str(primary_url)),
#             None
#         )
...
#                 primary_item.get("distilled_content", {}),
#                 primary_url,
#                 subtopic_id,
#                 num_primary,
#                 "medium"
...
#         # other sources
#         others = [
#             i for i in distilled_results
#             if str(i.get("url")) != str(primary_url)
#         ]
